                        ...
                        <div class="col-lg-6 col-md-12 col-sm-12">
                            ...
                            <div class="breadcrumb-list">
                                <ul>
                                    ...
                                    <li class="breadcrumb-item active"><a href="#" class="breadcrumb-link">Profile</a></li>
                                </ul>
                            </div>
                            <!-- breadcrumb-list - end -->
                            ...
                            <form action="./update-profile.php" method="post">
                                ...
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="txtFirstName" class="form-control" id="inputFirstName" type="text" placeholder="Enter your first name" value="<?= $userRow["first_name"] ?>">
                                    </div>
                                    <!-- Form Group (last name)-->
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="inputLastName">Last name</label>
                                        <input name="txtLastName" class="form-control" id="inputLastName" type="text" placeholder="Enter your last name" value="<?= $userRow["last_name"] ?>">
                                    </div>
                                </div>
                                <!-- Form Row        -->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input name="txtAddress" class="form-control" id="inputLocation" type="text" placeholder="Enter your location" value="<?= $userRow["address"] ?>">
                                    </div>
                                </div>

                                <div class="row gx-3 mb-3">
                                    <div class="col-md-6">
                                        <label class="small mb-1" for="selCity">City</label>
                                        <select id="selCity" name="selCity" class="form-control">
                                            <?php
                                            $fetchCities = "SELECT city_id, city_name FROM city_master ORDER BY city_name";
                                            $rsCity = $conn->query($fetchCities);
                                            while ($cityRow = $rsCity->fetch_array()) {
                                                if ($cityRow[0] == $userRow['city_id']) {
                                                    echo "<option selected value='$cityRow[0]'>$cityRow[1]</option>";
                                                } else {
                                                    echo "<option value='$cityRow[0]'>$cityRow[1]</option>";
                                                }
                                            }
                                            ?>
                                        </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input name="txtEmail" class="form-control" id="inputEmailAddress" type="email" placeholder="Enter your email address" value="<?= $userRow["email_id"] ?>">
                                </div>
                                <!-- Form Row-->
                                <div class="row gx-3 mb-3">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input name="txtPhone" class="form-control" id="inputPhone" type="tel" maxlength="10" placeholder="Enter your phone number" value="<?= $userRow["contact"] ?>">
                                    </div>
                                    <!-- Form Group (birthday)-->
                                    <!-- <div class="col-md-6">
