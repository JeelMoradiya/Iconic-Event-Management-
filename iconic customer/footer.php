					...
					<div class="row">
						...
						<div class="col-lg-7 col-md-12 col-sm-12">
							<div class="copyright-text">
								<p class="m-0"> <a href="#!" class="site-link">iconic.com</a></p>
								<!-- all right reserved, made with <i class="fas fa-heart"></i> by <a href="#!" class="author-link"><strong>jThemes Studio</strong> -->
							</div>
						</div>
						<!-- copyright-text - end -->
