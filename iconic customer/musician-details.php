...
if (isset($_GET["i"])) {
    ...
    $fetchVendorDetails = "SELECT company_name, city_name, CONCAT(first_name, ' ', last_name) AS manager_name, address, description, terms, starting_price, startup_year, per_ten_song_fee, album_fee, photo1, photo2, photo3, photo4, video1, video2
        FROM musician
...
<body class="default-header-p">
                    ...
                    <div class="event-details mb-80">
                        ...
                        <form id="bookingForm" action="./add-booking.php" method="post">
                            ...
                            <div class="input-group">
                                <span class="input-group-text">Songs</span>
                                <input id="noOfSongs" class="form-control" type="number" name="noOfSongs" value="10" min="10" step="10" readonly>
                                <button type="button" id="btnPlus" class="btn btn-outline-secondary">+</button>
                                <button type="button" id="btnMinus" class="btn btn-outline-secondary">-</button>
                            </div>
                            ...
                            <div class="input-group mb-2">
                                ...
                                <input type="text" name="price" id="price" class="form-control" value="<?= $vendorRow["per_ten_song_fee"] ?>" readonly required>
                            </div>
                            <br>

                            <button type="submit" name="btnMusician" class="custom-btn">Add To Booking</button>
                        ...
                        <div class="pricing-list ul-li clearfix">
                            <ul>
                                ...
                                <li class="pricing-table popular-pricing-table">
                                    ...
                                    <div class="pricing-header clearfix">
                                        <span id="per10SongFee" class="amount">&#8377;<?= $vendorRow['per_ten_song_fee'] ?></span>
                                        <h3 class="pricing-table-title">Per 10 Songs</h3>
                                    </div>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            let per10SongFee = document.getElementById("per10SongFee").textContent.substring(1);
            let price = document.getElementById("price");

            let noOfSongs = document.getElementById("noOfSongs");
            ...
            btnPlus.addEventListener("click", function() {
                noOfSongs.value = parseFloat(noOfSongs.value) + 10;
                price.value = parseFloat(noOfSongs.value) / 10 * parseFloat(per10SongFee);
            });

            btnMinus.addEventListener("click", function() {
                if (noOfSongs.value > 10) {
                    noOfSongs.value = parseFloat(noOfSongs.value) - 10;
                    price.value = parseFloat(noOfSongs.value) / 10 * parseFloat(per10SongFee);
                }
            });
            ...
            bookingForm.addEventListener("submit", function(event) {
                ...
                if (validateDate(hStartDate, "Start Date") == true && validateDate(hEndDate, "End Date") == true && validatePrice(price)) {
                    bookingForm.submit();
                }
            });
        }
