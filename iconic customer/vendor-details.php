...
if (isset($_GET["i"])) {
    ...
    if ($vendorType == "C") {
        ...
        WHERE caterer_id = ?";
    } else if ($vendorType == "M") {
        $vendorTypeName = "musician";
        $fetchVendorDetails = "SELECT company_name, city_name, CONCAT(first_name, ' ', last_name) AS manager_name, address, description, terms, starting_price, startup_year, per_hour_fee, per_day_fee, album_fee, photo1, photo2, photo3, photo4, video1, video2
        FROM musician
        INNER JOIN user ON musician.musician_id = user.user_id
        INNER JOIN city_master ON user.city_id = city_master.city_id
        WHERE musician_id = ?";
    } else if ($vendorType == "P") {
        $vendorTypeName = "photographer";
        $fetchVendorDetails = "SELECT company_name, city_name, CONCAT(first_name, ' ', last_name) AS manager_name, address, description, terms, starting_price, startup_year, basic_photography_fee, basic_videography_fee, photo1, photo2, photo3, photo4, video1, video2
        FROM photographer
...
<body class="default-header-p">
                ...
                <div class="col-lg-8 col-md-12 col-sm-12">
                            ...
                            <ul>
                                ...
                                <li>
                                    ...
                                    <div class="event-content">
                                        <?php
                                        if ($vendorType != "C") { ?>
                                            <small class="event-title">Vendor Type</small>
                                            <h3 class="event-date"><?= $vendorTypeName ?></h3>
                                        <?php
                                        } else {  ?>
                    ...
                    <div class="event-details mb-80">
                        ...
                        <form id="bookingForm" action="./add-booking.php" method="post">
                            ...
                            <input type="hidden" id="hdnVendorType" value="">
                            ...
                            <div id="hourDiv">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="date" id="hStartDate" class="form-control">
                                    <span class="input-group-text">Start Time</span>
                                    <input type="time" id="hStartTime" class="form-control">
                                </div>
                                <div class="input-group mb-4">
                                    <span class="input-group-text">End Date</span>
                                    <input type="date" id="hEndDate" class="form-control">
                                    <span class="input-group-text">End Time</span>
                                    <input type="time" id="hEndTime" class="form-control">
                                </div>
                            </div>
                            ...
                            <div id="dayDiv">
                                <div class="input-group mb-4">
                                    <span class="input-group-text">Start Date</span>
                                    <input type="date" id="dStartDate" class="form-control">
                                    <span class="input-group-text">End Date</span>
                                    <input type="date" id="dEndDate" class="form-control">
                                </div>
                            </div>

                            <div id="photoDiv">
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="chkPhoto">
                                    <label class="form-check-label" for="chkPhoto">Photography</label>
                                </div>
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="chkVideo">
                                    <label class="form-check-label" for="chkVideo">Videography</label>
                                </div>
                            </div>
                            ...
                            <div id="plateDiv">
                                <div class="input-group mb-4">
                                    ...
                                    <input type="number" id="noOfPlates" class="form-control">
                                </div>
                            </div>
                            ...
                            <button type="submit" class="custom-btn">Add To Booking</button>
                            ...
                            <ul>
                                ...
                                if ($vendorType == "M") {   ?>
                                    <li class="pricing-table popular-pricing-table">
                                        ...
                                        <div class="pricing-header clearfix">
                                            <span id="mDay" class="amount">&#8377;<?= $vendorRow['per_day_fee'] ?></span>
                                    ...
                                    <li class="pricing-table">
                                        <div class="pricing-header clearfix">
                                            <span id="mHour" class="amount">&#8377;<?= $vendorRow['per_hour_fee'] ?></span>
                                    ...
                                    <li class="pricing-table">
                                        <div class="pricing-header clearfix">
                                            <span id="mAlbum" class="amount">&#8377;<?= $vendorRow['album_fee'] ?></span>
                                            <h3 class="pricing-table-title">Album Fee</h3>
                                        </div>
                                    </li>
                                <?php
                                }
                                ...
                                if ($vendorType == "P") {   ?>
                                    <li class="pricing-table">
                                        <div class="pricing-header clearfix">
                                            <span id="pPhoto" class="amount">&#8377;<?= $vendorRow['basic_photography_fee'] ?></span>
                                            <h3 class="pricing-table-title">Basic Photogrpahy Fee</h3>
                                        </div>
                                    ...
                                    <li class="pricing-table">
                                        <div class="pricing-header clearfix">
                                            <span id="pVideo" class="amount">&#8377;<?= $vendorRow['basic_videography_fee'] ?></span>
                                            <h3 class="pricing-table-title">Basic Videogrpahy Fee</h3>
                                        </div>
                                    ...
                                    <li class="pricing-table">
                                        <div class="pricing-header clearfix">
                                            <span id="pAlbum" class="amount">&#8377;<?= $vendorRow['album_fee'] ?></span>
                                            <h3 class="pricing-table-title">Album Fee</h3>
                                        </div>
                                    </li>
                                <?php
                    ...
                    <div class="reviewer-comment-wrapper mb-30 clearfix">
                        ...
                        if ($vendorType == "C") {
                            ...
                            $fetchReviews = "SELECT profile_img, CONCAT(first_name, ' ', last_name) AS customer_name, rating, review
                            FROM user
                            INNER JOIN musician_rating ON user.user_id = musician_rating.customer_id
                            WHERE musician_id = ?";
                        } else if ($vendorType == "P") {
                            $fetchReviews = "SELECT profile_img, CONCAT(first_name, ' ', last_name) AS customer_name, rating, review
                            FROM user
                            INNER JOIN photographer_rating ON user.user_id = photographer_rating.customer_id
                            WHERE photographer_id = ?";
                        }

                        // $fetchReviews = "SELECT profile_img, CONCAT(first_name, ' ', last_name) AS customer_name, rating, review
                        //     FROM user
                        //     INNER JOIN ? ON user.user_id = ?.customer_id
                        //     WHERE ? = ?";
    ...
    <script>
        ...
        window.onload = function() {
            let vendorType = document.getElemtById("hdnVendorType").value;
            ...
            let plateDiv = document.getElementById("plateDiv");
            ...
            if (vendorType == "C") {
                ...
                price.value = `${noOfPlates * startPrice}`;
                

            } else if ("M") {
                // Take per hour / per day fee
                selType.style.display = "block";
                let mDayFee = document.getElementById("mDay").textContent.substring(1);
                let mHourFee = document.getElementById("mHour").textContent.substring(1);
                let mAlbumFee = document.getElementById("mAlbum").textContent.substring(1);
                ...
                hEndTime.addEventListener("change", function() {
                    ...
                    price.value = `${hourDifference * mHourFee}`;
                });
                ...
                dEndDate.addEventListener("change", function() {
                    ...
                    price.value = `${dayDifference * mDayFee}`;
                });

            } else if ("P") {
                // Take photgraphy / videography fee
                // and date time
                photoDiv.style.display = "block";
                hourDiv.style.display = "block";
                let pPhotoFee = document.getElementById("pPhoto").textContent.substring(1);
                let pVideoFee = document.getElementById("pVideo").textContent.substring(1);
                let pAlbumFee = document.getElementById("pAlbum").textContent.substring(1);
                ...
                hEndTime.addEventListener("change", function() {
                    ...
                    let hourDifference = timeDifference / (1000 * 3600);
                    console.log(hourDifference);
                    price.value = `${hourDifference * perHourFee + (noOfAlbums * pAlbumFee)}`;
                });
            }
