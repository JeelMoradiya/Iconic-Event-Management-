...
if (isset($_GET["i"])) {
    ...
    $fetchVendorDetails = "SELECT company_name, city_name, CONCAT(first_name, ' ', last_name) AS manager_name, address, description, terms, starting_price, startup_year, basic_photography_fee, basic_videography_fee, album_fee, photo1, photo2, photo3, photo4, video1, video2
        FROM photographer
...
<body class="default-header-p">
                    ...
                    <div class="event-details mb-80">
                        ...
                        <form id="bookingForm" action="./add-booking.php" method="post">
                            ...
                            <div id="photoDiv">
                                ...
                                <div class="form-check form-switch">
                                    <input class="form-check-input" type="checkbox" id="chkAlbum">
                                    <label class="form-check-label" for="chkVideo">Album</label>
                                </div>
                            </div>
                            ...
                            <button type="submit" name="btnPhotographer" class="custom-btn">Add To Booking</button>
                        ...
                        <div class="pricing-list ul-li clearfix">
                            <ul>
                                ...
                                <li class="pricing-table popular-pricing-table">
                                    ...
                                    <div class="pricing-header clearfix">
                                        <span id="photoFee" class="amount">&#8377;<?= $vendorRow['basic_photography_fee'] ?></span>
                                        <h3 class="pricing-table-title">Photography</h3>
                                    </div>
                                ...
                                <li class="pricing-table">
                                    <div class="pricing-header clearfix">
                                        <span id="videoFee" class="amount">&#8377;<?= $vendorRow['basic_videography_fee'] ?></span>
                                        <h3 class="pricing-table-title">Videography</h3>
                                    </div>
                                </li>

                                <li class="pricing-table">
                                    <div class="pricing-header clearfix">
                                        <span id="albumFee" class="amount">&#8377;<?= $vendorRow['album_fee'] ?></span>
    ...
    <script>
        ...
        window.onload = function() {
            ...
            let chkPhoto = document.getElementById("chkPhoto");
            let chkVideo = document.getElementById("chkVideo");
            let chkAlbum = document.getElementById("chkAlbum");
            ...
            let photoFee = document.getElementById("photoFee").textContent.substring(1);
            let videoFee = document.getElementById("videoFee").textContent.substring(1);
            let albumFee = document.getElementById("albumFee").textContent.substring(1);
            let price = document.getElementById("price");

            
            chkPhoto.addEventListener("change", function() {
                if (chkPhoto.checked == true) {
                    price.value = parseFloat(price.value) + parseFloat(photoFee);
                }
                else {
                    price.value = parseFloat(price.value) - parseFloat(photoFee);
                }
            ...
            chkVideo.addEventListener("change", function() {
                if (chkVideo.checked == true) {
                    price.value = parseFloat(price.value) + parseFloat(videoFee);
                }
                else {
                    price.value = parseFloat(price.value) - parseFloat(videoFee);
                }
            ...
            chkAlbum.addEventListener("change", function() {
                if (chkAlbum.checked == true) {
                    price.value = parseFloat(price.value) + parseFloat(albumFee);
                }
                else {
                    price.value = parseFloat(price.value) - parseFloat(albumFee);
                }
            ...
            bookingForm.addEventListener("submit", function(event) {
                ...
                if (validateDate(hStartDate, "Start Date") == true && validateDate(hEndDate, "End Date") == true && validatePrice(price) == true) {
                    bookingForm.submit();
                }
            });
        }
